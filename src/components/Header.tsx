  ...
  return (
    <header
      className={`fixed w-full top-0 left-[50%] translate-x-[-50%] z-50 transition-all duration-300 ${
        isScrolled
          ? 'top-3 left-[50%] rounded-full translate-x-[-50%] w-[85vw] bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-lg border-b border-gray-100/50 dark:border-gray-700/50'
          : 'bg-transparent'
      }`}
    >
